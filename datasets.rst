...
The dataset name consists of three parts separated by "/", e.g. "/TauPlusX/Run2011A-12Oct2013-v1/AOD". The first part indicates the primary dataset name (TauPlusX), the second part is the data-taking era (Run2011A) and reprocessing (12Oct2013), and the last one indicates the data format (AOD).
